...
define(['services/routeResolver'], function () {
    ...
    var app = angular.module('ewgApp', ['ngRoute', 'routeResolverServices', 'ngFileUpload', 'ui.bootstrap', 'dialogs.main']);
    ...
    app.config(['$routeProvider', 'routeResolverProvider', '$controllerProvider',
        ...
        function ($routeProvider, routeResolverProvider, $controllerProvider,
            ...
            routeResolverProvider.routeConfig.setBaseDirectories('/views/', '/js/controllers/');
